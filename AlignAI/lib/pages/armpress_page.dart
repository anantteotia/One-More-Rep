...
class ArmPressPage extends StatefulWidget {
  final List<CameraDescription> cameras;
  final String title;
  const ArmPressPage({this.cameras, this.title});
  @override
  _ArmPressPageState createState() => _ArmPressPageState();
}

class _ArmPressPageState extends State<ArmPressPage> {
  List<dynamic> _data;
  int _imageHeight = 0;
  int _imageWidth = 0;
  int x = 1;
